...
| 1.2 | **Debounce 250 ms → 75 ms** | Middle ground between aggressive (50 ms) and conservative (~100 ms) industry targets. Viable now that KV cache reuse (1.1) lands — delta decode on the next poll catches any AX staleness cheaply. |
